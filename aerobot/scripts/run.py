...
if __name__ == '__main__':
    ...
    parser.add_argument('--n-epochs', default=20, type=int, help='The maximum number of epochs to train the Nonlinear classifier.') 
    parser.add_argument('--weight-decay', default=0.01, type=int, help='The L2 regularization penalty to be passed into the Adam optimizer of the Nonlinear classifier.') 
    ...
    parser.add_argument('--early-stopping', default=True, type=bool, help='Whether or not to use early stopping during Nonlinear classifier training.') 
    ...
    params = read_params(model_class, args) # Read in model parameters from the command-line arguments.
